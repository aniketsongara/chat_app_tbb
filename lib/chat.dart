...
class ChatScreenState extends State<ChatScreen> {
  ...
  Future uploadEditorFile(File file) async {
    ...
    ref.putFile(file, StorageMetadata(contentType: 'application/json'));
            ...
            child: FlatButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => EditorPage(serverFile :
                            document['content'])));
              },
              padding: EdgeInsets.all(0),
            ),
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => EditorPage(serverFile:   document['content'],)));
                    },
                    padding: EdgeInsets.all(0),
                  ),
                  margin: EdgeInsets.only(
